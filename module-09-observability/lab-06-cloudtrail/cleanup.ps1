...
$StackName = "dva-lab-09-06-cloudtrail"
$Bucket = aws cloudformation describe-stacks --stack-name $StackName --query "Stacks[0].Outputs[?OutputKey=='TrailBucket'].OutputValue" --output text 2>$null
